         ...
         >
          ...
          <Stack sx={(theme) => ({ backgroundColor: '#DDCBA4' })}>
            ...
            <Button sx={(theme) => ({ backgroundColor: '#9B2242', '&:hover':
             { backgroundColor: theme.fn.darken('#97999B', 0.05), }, })} size="md" compact leftIcon={<BiPlus />}><Link href='Captura'>Capturar</Link></Button>
            <Button sx={(theme) => ({ backgroundColor: '#9B2242', '&:hover': 
            { backgroundColor: theme.fn.darken('#97999B', 0.05), }, })} size="md" compact leftIcon={<FaEdit />}><Link href='editar'>Editar</Link></Button>
            <Button sx={(theme) => ({ backgroundColor: '#9B2242', '&:hover': 
            { backgroundColor: theme.fn.darken('#97999B', 0.05), }, })} size="md" compact leftIcon={<BiArrowBack />}><Link href='inicio'>Regresar</Link></Button>
